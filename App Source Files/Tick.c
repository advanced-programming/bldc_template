 ...
 *********************************************************************
 * FileName:        Tick.c
 * Dependencies:    Timer 0 (PIC18), Timer 1 (PIC32) or Timer 2 (PIC24F, PIC24H, 
 *					dsPIC30F, dsPIC33F)
 ...
 * Author               Date    				Comment
 *~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 * Serge Hould			6 June 2018		New version of Tick library
 *													modified to use timer2 
 *													rather than Timer1.
 *                                      GetTickCopy() got stuck in a do loop 
 *                                          so the 'do' loop was removed.  
 *                                          The function is then not interrupt 
 *                                          safe anymore.
