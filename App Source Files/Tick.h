 ...
 * Author               Date    				Comment
 *~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 * Serge Hould			6 May 2018		New version of Tick library
 *													modified to use timer2 
 *													rather than Timer1.
...
#define GetSystemClock()		(14740000ul)      // Hz		
...
#define TICKS_PER_SECOND		((GetPeripheralClock()+128ull)/64ull)	// Internal core clock drives timer
...
#define TICK_500MS				((QWORD)TICKS_PER_SECOND/2)
#define TICK_10MS				((QWORD)TICKS_PER_SECOND/100)
